				...
				<div class="col-md-6 offset-md-3">
					<div class="addBook-form">
						<form id="addBook" action="/add_book" method="post" class="mt-5">
							...
							<button class="btn btn-primary text-center" id="add-user"
								type="submit" style="margin-left: 100px">Submit</button>
							<button class="btn btn-danger text-center" id="cancelBtn"
								type="button" name="cancel" style="margin-left: 25px"
